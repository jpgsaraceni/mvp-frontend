...
export const audios = {
  background: {
    ...
    phases: {
      world:
        'https://cdn.artlist.io/artlist-song-aac/382845__382517_Alon_Peretz_-_Colors_Of_Playful_-_Spring_In_My_Step_-_Master_V2_-_INT_-_X_-_2444.aac',
    },
  },
  events: {
    error:
      'https://cdn.artlist.io/artlist-sfx-aac/465113_Beeps_and_Bells_34_normal.aac',
    success:
      'https://cdn.artlist.io/artlist-sfx-aac/422590_Magic_and_Spell_Sounds_-_chimes_magic_bell_ding_1_normal.aac',
    phaseEnd:
      'https://cdn.artlist.io/artlist-sfx-aac/509521_UI_NewRecord_Tada_normal.aac',
  },
};
